...
WebUI.callTestCase(findTestCase('Pages/Edit Product/Input Product Description'), [('product_description') : ''], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Pages/Edit Product/Tap Image'), [:], FailureHandling.STOP_ON_FAILURE)

Mobile.tapOnImage('Phone/Pictures/Screenshoots/Screenshoots_2022-10-29-19-32-26-70_35795c8e8abd9377d5cbdbb6cd68c.jpg', FailureHandling.STOP_ON_FAILURE)
