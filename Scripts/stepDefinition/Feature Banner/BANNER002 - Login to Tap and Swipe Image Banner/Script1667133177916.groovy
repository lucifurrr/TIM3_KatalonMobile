...
Mobile.tap(findTestObject('navigation_bar/nav_beranda'), 0)

Mobile.delay(1.5, FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Pages/homepage/Tap and Swipe Banner'), [:], FailureHandling.STOP_ON_FAILURE)
