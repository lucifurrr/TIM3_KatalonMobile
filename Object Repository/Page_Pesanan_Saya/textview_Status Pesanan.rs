...
<MobileElementEntity>
   ...
   <name>textview_Status Pesanan</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Menunggu' or . = 'Menunggu') and @resource-id = 'id.binar.fp.secondhand:id/tv_product_status']</locator>
