...
<MobileElementEntity>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'ufucu' or . = 'ufucu') and @resource-id = 'id.binar.fp.secondhand:id/tv_product_name']</locator>
