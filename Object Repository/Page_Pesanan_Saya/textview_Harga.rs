...
<MobileElementEntity>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Rp123' or . = 'Rp123') and @resource-id = 'id.binar.fp.secondhand:id/tv_product_price']</locator>
